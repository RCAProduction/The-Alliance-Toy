...
//#TPT-Directive ElementClass Element_CGLS PT_CGLS 200
Element_CGLS::Element_CGLS()
{
	Identifier = "DEFAULT_PT_CGLS";
	Name = "CGLS";
	...
	Update = &Element_CGLS::update;
	
}

//#TPT-Directive ElementHeader Element_CGLS static int update(UPDATE_FUNC_ARGS)
int Element_CGLS::update(UPDATE_FUNC_ARGS)
 {
